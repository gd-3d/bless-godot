# this gets a profile of godot built in classes.
# the resulting json is massive, and has every single Node3D type and property.
# experimental, not used yet, might not be needed.

extends Resource
#class_name BlessEngineProfile
